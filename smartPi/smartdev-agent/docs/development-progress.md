...
| test_patch.py | 28 | Patch 数据模型 + find-replace/序列化/路径安全（Phase 9 Step 1A，11+17） |
...
| Step 1B | core/patch.py apply/rollback | 🔲 待执行 | 写盘 + 备份 + apply 前 hash 校验 |
